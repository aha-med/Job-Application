...
import com.ahamed.companyms.company.impl.CompanyServiceImpl;
...
public class CompanyController {
    ...
    public ResponseEntity<List<Company>> getAllCompanies(){
        return new ResponseEntity<>(companyServiceImpl.getAllCompanies(),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> updateCompany(@PathVariable Long id,
        ...
        companyServiceImpl.updateCompany(company, id);
    ...
    public ResponseEntity<String> deleteCompany(@PathVariable Long id){
        boolean isDeleted = companyServiceImpl.deleteCompanyById(id);
        if (isDeleted) {
